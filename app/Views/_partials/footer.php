<!--  isset($grafik) untuk memastikan apakah variable $grafik di assign ke footer.php atau tidak.
...
<footer class="main-footer">
    <div class="float-right d-none d-sm-inline">
        Sistem Informasi Pemeliharaan Kendaraan
    </div>
    <strong>Copyright © <?= date('Y'); ?> <a href="<?php echo base_url('/'); ?>">SPK Online</a>.</strong> All rights reserved.
</footer>
</div>
...
<?php if (isset($grafik) && isset($month)) { ?>
